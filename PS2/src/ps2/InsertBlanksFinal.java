...
public class InsertBlanksFinal {
...
//		ArrayList<String> wordsWithBlanks = splitIntoWords(str);
		ArrayList<String> wordsWithBlanks = splitIntoWords("maskingspeonfreightersunderdonerosinredistributedunknotaleatory");
		
//		System.out.println("Result of inserting blanks in `" + str + "`: ");
		System.out.println("Result of inserting blanks in `maskingspeonfreightersunderdonerosinredistributedunknotaleatory`: ");
